...
const index = () => {
  ...
  return (
    <div className="homePage">
      ...
      <SEO
        title={"Terms of Use - Aether Pantheon"}
        description={
          "Discover the terms governing the use of Aether Pantheon's services. Understand the guidelines for a seamless and secure user experience"
        }
      />
      <Header />
      <div className="main-content">
        <h1 className="main-heading text-center">Terms of Use</h1>
